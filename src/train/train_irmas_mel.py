"""
Train IRMAS-only CNN model.

Usage:
  python src/train/train_irmas_mel.py
  python src/train/train_irmas_mel.py --run_name IRMAS_mel_v1 --resume
"""
...
def main() -> None:
    ...
    ap.add_argument("--run_name", default="IRMAS_mel_v1")
    ap.add_argument(
        "--weights_dir",
        default=None,
    ...
    ap.add_argument(
        "--manifests",
        nargs="+",
        default=["data/processed/irmas_train_mels.csv"],
