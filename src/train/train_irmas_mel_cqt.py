...
def main() -> None:
    ...
    ap.add_argument("--run_name", default="IRMAS_mel_cqt_v1")
    ap.add_argument("--weights_dir", default=None, help="Override weights dir; default uses src/models/saved_weights/<run_name>")
    ap.add_argument("--manifests", nargs="+", default=["data/processed/irmas_train_mels.csv"], help="One or more manifest CSVs")
    ap.add_argument("--labels_yaml", default="src/configs/labels_irmas.yaml")
    ap.add_argument("--audio_yaml", default="src/configs/audio_params_irmas.yaml")
