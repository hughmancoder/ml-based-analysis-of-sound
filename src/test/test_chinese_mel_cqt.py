...
python src/test/test_chinese_mel_cqt.py \
  --weights_run Chinese_mel_cqt_v1 \
...
def main() -> None:
    ...
    ap.add_argument("--weights_run", default="Chinese_mel_cqt_v1")
    ap.add_argument("--weights_path", default=None, help="Override exact model weights path")
    ap.add_argument("--test_manifest", default="data/test/a-touch-of-zen.csv")
