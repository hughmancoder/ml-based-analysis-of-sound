...
def main() -> None:
    ...
    mel_cache_root = guard_path(Path(args.out_cache_root), PROJECT_ROOT, "out_cache_root")
    cqt_cache_root = guard_path(Path(args.out_cqt_root), PROJECT_ROOT, "out_cqt_root")
